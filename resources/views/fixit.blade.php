...
<head>
    ...
    <!-- Stylesheet -->
    <link rel="stylesheet" href="fix/css/style.css">
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12 d-flex justify-content-between">
                    <!-- Logo Area -->
                    <div class="logo">
                        <a href="index.html"><img src="fix/img/core-img/logo.png" alt=""></a>
                    </div>

                    <!-- Top Contact Info -->
                    <div class="top-contact-info d-flex align-items-center">
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="25 th Street Avenue, Los Angeles, CA"><img src="fix/img/core-img/placeholder.png" alt=""> <span>25 th Street Avenue, Los Angeles, CA</span></a>
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="office@yourfirm.com"><img src="fix/img/core-img/message.png" alt=""> <span>office@yourfirm.com</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="creditNav">
                    ...
                    <!-- Contact -->
                    <div class="contact">
                        <a href="#"><img src="fix/img/core-img/call2.png" alt=""> +800 49 900 900</a>
                    </div>
                </nav>
            </div>
        </div>
...
<div class="hero-area">
    <div class="hero-slideshow owl-carousel">
        ...
        <div class="single-slide bg-img">
            <!-- Background Image-->
            <div class="slide-bg-img bg-img bg-overlay" style="background-image: url(fix/img/bg-img/1.jpg);"></div>
            <!-- Welcome Text -->
            <div class="container h-100">
        ...
        <div class="single-slide bg-img">
            <!-- Background Image-->
            <div class="slide-bg-img bg-img bg-overlay" style="background-image: url(fix/img/bg-img/5.jpg);"></div>
            <!-- Welcome Text -->
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-12 col-lg-9">
...
<section class="cta-area d-flex flex-wrap">
    <!-- Cta Thumbnail -->
    <div class="cta-thumbnail bg-img jarallax" style="background-image: url(fix/img/bg-img/5.jpg);"></div>
        ...
        <div class="row align-items-end justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="add-area mb-100 wow fadeInUp" data-wow-delay="100ms">
                    <a href="#"><img src="fix/img/bg-img/add.png" alt=""></a>
                </div>
            </div>
                ...
                <div class="contact--area mb-100 wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <div class="contact-content">
                        ...
                        <div class="single-contact-content d-flex align-items-center">
                            <div class="icon">
                                <img src="fix/img/core-img/location.png" alt="">
                            </div>
                            <div class="text">
                        ...
                        <div class="single-contact-content d-flex align-items-center">
                            <div class="icon">
                                <img src="fix/img/core-img/call.png" alt="">
                            </div>
                            <div class="text">
                                <p>337-413-9538</p>
                        ...
                        <div class="single-contact-content d-flex align-items-center">
                            <div class="icon">
                                <img src="fix/img/core-img/message2.png" alt="">
                            </div>
                            <div class="text">
                ...
                <div class="news--area mb-100 wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <div class="single-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/10.jpg" alt="">
                        </div>
                        <div class="news-content">
                            <span>July 18, 2018</span>
                            <a href="#">How to get the best loan online</a>
                            <div class="news-meta">
                                <a href="#" class="post-author"><img src="fix/img/core-img/pencil.png" alt=""> Jane Smith</a>
                                <a href="#" class="post-date"><img src="fix/img/core-img/calendar.png" alt=""> April 26</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/11.jpg" alt="">
                        </div>
                        <div class="news-content">
                            <span>July 18, 2018</span>
                    ...
                    <div class="single-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/12.jpg" alt="">
                        </div>
                        <div class="news-content">
                            <span>July 18, 2018</span>
...
<section class="newsletter-area section-padding-100 bg-img jarallax" style="background-image: url(fix/img/bg-img/6.jpg);">
    <div class="container">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-footer-widget mb-100">
                    ...
                    <div class="single-latest-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/7.jpg" alt="">
                        </div>
                        <div class="news-content">
                    ...
                    <div class="single-latest-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/8.jpg" alt="">
                        </div>
                        <div class="news-content">
                    ...
                    <div class="single-latest-news-area d-flex align-items-center">
                        <div class="news-thumbnail">
                            <img src="fix/img/bg-img/9.jpg" alt="">
                        </div>
                        <div class="news-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copywrite-content d-flex flex-wrap justify-content-between align-items-center">
                        <!-- Footer Logo -->
                        <a href="index.html" class="footer-logo"><img src="fix/img/core-img/logo.png" alt=""></a>
...
<!-- jQuery-2.2.4 js -->
<script src="fix/js/jquery/jquery-2.2.4.min.js"></script>
<!-- Popper js -->
<script src="fix/js/bootstrap/popper.min.js"></script>
<!-- Bootstrap js -->
<script src="fix/js/bootstrap/bootstrap.min.js"></script>
<!-- All Plugins js -->
<script src="fix/js/plugins/plugins.js"></script>
<!-- Active js -->
<script src="fix/js/active.js"></script>
</body>
