...
<div class="wrapper">
    ...
    <header class="main-header" id="home">
        <div class="content-table header-content-fixed ">
            ...
            <div class="v-content">
                <div class="container">
                    <h1 class="text-uppercase color-dark name">i’m Alexey Karpelev </h1>
            ...
            <div class="my-pict" >
                <div class="overfly">
                    <div class="text-botttom">
                        <h2 class="text-uppercase color-dark text-bold">Alexey Karpelev</h2>
                ...
                <div class="bg-dark clearfix">
                    <div class="inner-text">
                        <p class="no-margin color-light ">
                            <strong class="fix-width-100"><i class="fa fa-calendar margin-right-5"></i> Birthdate</strong> : 30/10/1976<br/>
                            <strong class="fix-width-100"><i class="fa fa-skype margin-right-5"></i> Skype</strong> : alekseykarpelev@gmail.com<br/>
                            <strong class="fix-width-100"><i class="fa fa-phone margin-right-5"></i> Phone</strong> : + 7-902-064-80-16<br/>
                            <strong class="fix-width-100"><i class="fa fa-envelope margin-right-5"></i> Email</strong> : alekseykarpelev@gmail.com<br/>
                            <strong class="fix-width-100"><i class="fa fa-globe margin-right-5"></i> Website</strong> : karpelev.com<br/>
    ...
    <section id="resume" class="block-section">
            ...
            <div class="list-education">
                <ul class="list-unstyled  clearfix">
                    <li>
                        ...
                        <div class="number font-alt">01</div>
                        <div class="desc">
                            <h5 class="text-uppercase color-dark text-bold">Московский открытый институт</h5>
                            <p class="font-alt color-dark"><a href="https://tl.moi.edu.ru/"  target="_blank"  >link</a> </p>
                            <p>Информационные управляющие комплексы системы и сети</p>
                            <p class="font-alt color-dark">  2015-2019</p>
                        </div>
                    </li>
                    <li>
                        <div class="ic"><i class="fa fa-graduation-cap"></i></div>
        ...
        <div class="container-medium">
            ...
            <ul class="skill top list-unstyled clearfix">
                ...
                <span class="chart" data-percent="15">
                  <span class="percent"></span>
                        ...
                        <div class="text-uppercase  color-dark">Linux</div>
                    </div>
                </li>
                <li class="col-sm-3 col-xs-6 no-padding">
                    <div class="box br-right br-bottom">
                ...
                <span class="chart" data-percent="15">
                  <span class="percent"></span>
                        ...
                        <div class="text-uppercase color-dark">laravel</div>
                    </div>
                </li>
            ...
            <ul class="skill bottom list-unstyled clearfix">
                ...
                <span class="chart" data-percent="15s">
                  <span class="percent"></span>
                </span>
